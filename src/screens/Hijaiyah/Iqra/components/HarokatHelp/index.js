...
export default class HelpModal extends PureComponent {
  ...
  render() {
    ...
    let caption = Languages[language].iqra.help.harakat
          ...
          >
            <View style={styles.wrapperText}>
              <View style={styles.header} >
                <Image 
                  source={ImagesPath.img.iqra.helpImage.harakat} 
              ...
              <View style={styles.imageHelp} >
                <Image 
                  source={ImagesPath.img.iqra.helpImage.fathah} 
                  style={styles.imageContain} 
                />
              </View>
              <Text style={styles.textHelp}> 
              ...
              <View style={styles.imageHelp} >
                <Image 
                  source={ImagesPath.img.iqra.helpImage.kasrah} 
                  style={styles.imageContain} 
                />
              </View>
              <Text style={styles.textHelp}> 
