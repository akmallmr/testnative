...
export default class Tanwin2 extends Component {
  constructor(props) {
    super(props)
        ...
        <ImageBackground 
          ...
          <View style={styles.harakat}>
            ...
            <Button
              ...
              onPress={() => this.setState({ selectedHarakat: 'dhammatain' })}
              animation={'bounceIn'}
              duration={1200}
              useNativeDriver={true}
            >
            ...
            <Button
              style={styles.harakatItem}
              onPress={() => this.setState({ selectedHarakat: 'kasratain' })}
              animation={'bounceIn'}
              duration={1200}
              useNativeDriver={true}
            >
            ...
            <Button
              style={styles.harakatItem}
              onPress={() => this.setState({ selectedHarakat: 'fathatain' })}
              animation={'bounceIn'}
              duration={1200}
              useNativeDriver={true}
            >
