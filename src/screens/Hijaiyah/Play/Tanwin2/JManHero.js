...
const { HARAKAT, COLOR, TANWIN_TYPE } = HIJAIYAH
...
export default class JManHero extends Component {
  ...
  render() {
    ...
    const HarakatSource = [
      ImagesPath.img.play.harakatMatch.fathatain,
      ImagesPath.img.play.harakatMatch.kasratain,
      ImagesPath.img.play.harakatMatch.dammatain
    ]
