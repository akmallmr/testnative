...
class Quran extends Component {
  ...
  downloadAudioAyah = () => {
    this.audioPlayerAyah
      .downloadFile(
        this.audioPlayerAyah.getInfo(
          this.state.sura,
          this.state.stateAyah.selectedAya
        )
      )
      .then(res => {
        this.setAudioAyah()
  ...
  togglePlayingAyah = () => {
    ...
    isPlaying
      ? this.audioPlayerAyah.navPlayer("PAUSE")
      : this.downloadAudioAyah()
  ...
  downloadAudioWord = () => {
    this.audioPlayerWord
      .downloadFile(
        this.audioPlayerWord.getInfoWBW(
          this.state.sura,
          this.state.stateWord.selectedAya,
          this.state.stateWord.selectedWord + 1
        )
      )
      .then(res => {
        this.setAudioWord()
  ...
  togglePlayingWord = () => {
    ...
    isPlaying
      ? this.audioPlayerWord.navPlayer("PAUSE")
      : this.downloadAudioWord()
    this.setState(prevState => ({
      audioPlay: !this.state.audioPlay,
      stateWord: {
