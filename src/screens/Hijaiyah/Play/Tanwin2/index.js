...
class Tanwin2 extends Component {
  ...
  twit = () => {
    ...
    let sound = SoundsPath.harakat[TANWIN_TYPE[harokat]][itemSelected.id]
  ...
  onTimeIsUp = () => {
    ...
    setTimeout(() => {
      ...
      this.setState({ star: star, result: true, help: false }, () => {
        this.props.setDataScore("tanwin2", { score, star })
        clearInterval(this.ticker)
      })
    }, 1000)
  }
  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          <Header
            headerSource={ImagesPath.img.play.topBoard.matchtanwin}
            leftButton={{
        ...
        <HelpModal
          source={ImagesPath.img.play.helpImage.tanwin2}
          text={LANGUAGE.play.help.tanwin2}
          visible={help}
          close={() =>
